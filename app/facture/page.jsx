...
export default function Home() {
    ...
    useEffect(() => {
      ...
      const filterData = async () => {
          ...
          if (selectedTypeSaisie == 1) {
            console.log('hehehee')
              const res = await fetchAllFactures1(itemsPerPage, (currentPage - 1) * itemsPerPage, lowercasedSearchId, lowercasedSearchIntitule,selectedTypeFacture,selectedTypeSaisie,setTotalPages);
  ...
  useEffect(() => {
    setCurrentPage(1);
  },[searchId, searchIntitule, selectedTypeFacture,selectedTypeSaisie]);
    ...
    return (
        <>
            <div className="p-4 overlay">
                ...
                <div className="mb-4">
                    ...
                    <div className="flex flex-col md:flex-row md:space-x-4">
                        ...
                        >
                            ...
                            <option value={4}>Facutre non comptable</option>
                ...
                <div>
                    {(selectedTypeSaisie == 1 || selectedTypeSaisie == 3 || selectedTypeSaisie == 4|| selectedTypeSaisie == 5) && filteredFactures.map((facture) => (
