...
export default function SaisieRemboursement({ formData, onChange,echenace }) {
    ...
    <div onSubmit={onSubmit} className="space-y-4">
      ...
      <div className="space-y-2 mt-4">
        ...
        {formData.mode_encaisement === 'virement' && (
          <div>
            <label htmlFor="compte" className="block text-gray-800 font-semibold mb-1">Numero Compte</label>
            <input
              type="text"
              id="compte"
              name="compte"
